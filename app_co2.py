...
gas_dict = {
  ...
  'Concentrations of water vapor': {'col': 'COPERNICUS/S5P/NRTI/L3_CO', 'band': 'H2O_column_number_density', 'min': 5e2,
                                    'max': 6e3, 'layer_name': 'S5P H20', 'label': 'H20 concentrations (mol/m^2)'},
